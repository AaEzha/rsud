...
<html>
<head>
  <title>Admin Pusat | RSUD Sidoarjo Management Service App</title>
...
<body class="dashboard-body">
  ...
  <div class="header-container">
    ...
    <div class="logout-container logout-btn" data-link="<?=base_url('adminpusat/auth/keluar');?>">
  ...
  <div class="footer-container">
    <a class="button-menu" href="<?=base_url('adminpusat/profil');?>">
      <div class="img-menu">
    ...
    <a class="button-menu" href="<?=base_url('adminpusat/dashboard');?>">
      <div class="img-menu">
    ...
    <a class="button-menu" href="<?=base_url('adminpusat/backup');?>">
      <div class="img-menu">
